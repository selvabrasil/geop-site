/*
 * GeOp Privacy Policy Page - Tactical Dark theme
  ...
  const sections = [
    {
      ...
      content: t("privacy_sec1_content"),
    },
    {
      title: t("privacy_sec2_title"),
      content: t("privacy_sec2_content"),
    },
    {
      title: t("privacy_sec3_title"),
      content: t("privacy_sec3_content"),
    },
    {
      title: t("privacy_sec4_title"),
      content: t("privacy_sec4_content"),
    },
    {
      title: t("privacy_sec5_title"),
      content: t("privacy_sec5_content"),
    },
    {
      title: t("privacy_sec6_title"),
      content: t("privacy_sec6_content"),
    },
  ];
        ...
        <div className="container max-w-3xl mx-auto">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-xs text-primary/60">POLICY</span>
